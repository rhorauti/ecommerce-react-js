...
function Signup() {
  ...
  useEffect(() => {
    if (signupRequirementsOk.isNameOk && signupRequirementsOk.isEmailOk && signupRequirementsOk.isPasswordOk) {
      setIsBtnDisabled(false);
    } else {
      setIsBtnDisabled(true);
    }
  }, [signupRequirementsOk.isNameOk, signupRequirementsOk.isEmailOk, signupRequirementsOk.isPasswordOk]);
          ...
          <div className="my-5 space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                inputValue={(value) => setSignupData((prevState) => ({ ...prevState, email: value }))}
                emailOk={(isEmailOk) =>

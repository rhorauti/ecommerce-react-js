...
import { getWishListItemsFromLocalStorage, removeWishListItem } from "@src/store/wish-list.store";
    ...
    <>
      <div className="p-7">
        ...
        <div className="flex flex-col items-center gap-5">
          <Button
            emitClickEvent={() => onSaveAllItems()}
            label="Adicionar tudo ao carrinho"
          ></Button>
